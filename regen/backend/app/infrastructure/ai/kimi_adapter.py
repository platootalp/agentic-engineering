...
class KimiAdapter(AIGateway):
    ...
    Uses the Moonshot API for chat completions.
    ...
    def __init__(
        ...
        Args:
            ...
            model: Optional model identifier (default: moonshot-v1-128k).
    ...
    async def chat_completion(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.debug(
                "Received response from Kimi API",
                extra={
                    "model": self.model,
    ...
    async def _handle_http_error(self, error: httpx.HTTPStatusError) -> None:
        """Handle HTTP errors from Kimi API.
